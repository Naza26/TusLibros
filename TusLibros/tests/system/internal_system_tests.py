...
class InternalTests(unittest.TestCase):
    ...
    def test_01_cannot_create_cart_when_client_id_is_missing(self):
        ...
        self._assert_parameter_is_required_for_cart_creation(client_id, self.password, "Client ID")

    def test_02_cannot_create_cart_when_password_is_missing(self):
        password = None

        self._assert_parameter_is_required_for_cart_creation(self.client_id, password, "Password")
    ...
    def test_04_cannot_add_to_cart_if_cart_id_is_missing(self):
        ...
        self._assert_parameter_is_required_for_cart_addition(cart_id, self.book_isbn, self._a_quantity_of_books(),
                                                             "Cart ID")
    ...
    def test_06_cannot_add_to_cart_if_book_quantity_is_missing(self):
        ...
        self._assert_parameter_is_required_for_cart_addition(self._a_cart_id(), self.book_isbn, book_quantity,
                                                             "Book Quantity")
